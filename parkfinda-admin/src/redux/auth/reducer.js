...
const INIT_STATE = {
    ...
    role: localStorage.getItem('role') || "enforcer",
...
export default (state = INIT_STATE, action) => {
    switch (action.type) {
        ...
        case LOGIN_USER_SUCCESS:
            return { ...state, loading: false, role: action.payload.role, user: action.payload.user.uid, displayName: action.payload.user.displayName, error: '' };
